...
public class ArticleDetailFragment extends Fragment implements
    ...
    private void bindViews() {
        ...
        ImageButton moreButton = mRootView.findViewById(R.id.btn_more);
        ...
        if (mCursor != null) {
            ...
            if (bodyText.length() > 1000) {
                ...
                if(isPortrait(getActivity())) {
                    bodyView.setMaxLines(22);
                    bodyView.setText(Html.fromHtml(bodyText.substring(0, 1001)));
                } else {
                    bodyView.setMaxLines(6);
                    bodyView.setText(Html.fromHtml(bodyText.substring(0, 401)));
                }
